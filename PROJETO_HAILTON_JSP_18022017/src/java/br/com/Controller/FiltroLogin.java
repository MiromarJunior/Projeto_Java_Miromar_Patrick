...
public class FiltroLogin implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //esta logado || httpRequest.getRequestURI().lastIndexOf("Login.do")>-1
        if(sessao.getAttribute("loginAtivo")!=null   
         || httpRequest.getRequestURI().lastIndexOf("login.html")>-1 || 
                httpRequest.getRequestURI().lastIndexOf("CadastrarUsuario.jsp")>-1
                ){
...
//        
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FiltroLogin::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FiltroLogin::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FiltroLogin::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FiltroLogin::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FiltroLogin::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
