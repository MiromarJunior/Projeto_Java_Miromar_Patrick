...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acao != null && acao.equals("cadPessoa")) {
        ...
        if (acao != null && acao.equals("altPessoa")) {
            ...
            request.setAttribute("listaCurso", listaCurso);
            //busco por id
            String pessoaPk = request.getParameter("pessPk");
            CdtrPessoaDAO pessoaDAO = new CdtrPessoaDAO();
            CdtrPessoa cdtrPessoa = pessoaDAO.getById(Integer.parseInt(pessoaPk));
            request.setAttribute("cdtrPessoa", cdtrPessoa);

            request.getRequestDispatcher("Pages/AlterarUsuario.jsp").forward(request, response);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String pessoaPk = request.getParameter("pessoaPk");
        ...
        if (pessoaPk != "0" && pessoaPk != "" && pessoaPk != null) {

            cdtrPessoa.setPessPk(Integer.parseInt(pessoaPk));
        }
